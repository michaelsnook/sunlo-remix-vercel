export default function LoginSignupForm() {
  return (
    <div className="bg-white text-gray-800 rounded px-6 py-8">
      ...
      <form className="py-4 flex flex-col gap-4">
        ...
        <button type="submit" className="py-4 px-6 bg-blue-600 hover:bg-blue-800 text-white rounded">Submit</button>
