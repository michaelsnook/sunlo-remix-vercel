...
const SignupForm = () => (
  <form className="py-4 flex flex-col gap-4">
    ...
    <div>
      ...
      <input placeholder="yourname@email.net" id="emailInput" name="email" type="email" className="rounded border border-gray-400 w-full" />
    </div>
    <div>
      <label htmlFor="passwordInput">Password</label>
      <input placeholder="************" id="passwordInput" name="password" type="password" className="rounded border border-gray-400 w-full" />
    </div>
    ...
    <div className="bg-white text-gray-800 rounded px-4 lg:px-6 py-4">
      <ul className="flex border-b">
        <li className={`${active === 'signup' ? '-mb-px' : '' } mr-1`}>
          <button
            className={`bg-white inline-block py-2 px-4 ${active === 'signup' ? 'border-l border-t border-r rounded-t text-blue-800' : 'text-blue-500 hover:text-blue-800'} font-semibold`}
            href="#"
        ...
        <li className={`${active === 'login' ? '-mb-px' : '' } mr-1`}>
          <button
            className={`bg-white inline-block py-2 px-4 ${active === 'login' ? 'border-l border-t border-r rounded-t text-blue-800' : 'text-blue-500 hover:text-blue-800'} font-semibold`}
